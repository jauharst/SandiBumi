...
| 5 | `core_rcal_SANDI-01.csv` | select SANDI-01 → Data → Import Data ▾ → **Import Core…** | ~15 plugs across both sands at native (off-grid) depths. Porosity/Sw arrive in **percent** — the importer auto-converts to v/v. Gas-zone plugs read Sw ≈ 0.32, water-zone ≈ 0.84. |

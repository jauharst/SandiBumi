...
- Gate 2 requirement progress: `31 / 222 handled — 21 DONE, 10 BLOCKED, 191 remaining`
- Baseline foundation: `COMPLETE`
- Active increment: `G2-T03 / SB-DBM-013 - DONE; T13 proves record/curve atomicity, per-well Failed reporting, explicit skip_version refusal and a corpus-wide configuration/writer inventory`

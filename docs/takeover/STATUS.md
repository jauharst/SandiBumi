...
- Gate 2 requirement progress: `27 / 222 handled — 20 DONE, 7 BLOCKED, 195 remaining`
- Baseline foundation: `COMPLETE`
- Active increment: `G2-T03 / SB-DBM-007 - DONE; schema-v3 ancestry names parameter absence, legacy readers preserve uncertainty, and module parameter serialization fails before any run or curve row is allocated`

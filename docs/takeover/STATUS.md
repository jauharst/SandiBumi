...
- Gate 2 requirement progress: `34 / 222 handled — 22 DONE, 12 BLOCKED, 188 remaining`
- Baseline foundation: `COMPLETE`
- Active increment: `G2-T03 / SB-DBM-017 - BLOCKED; DEC-025 records that exact T17 needs the typed neutron-scale metadata seam owned by pilot-excluded SB-ENV-012, and no hidden contractor, tool, salinity or matrix default may be invented`
...
| G2 — Silent-wrongness closure | IN PROGRESS | exact program: 222 owned here / 20 later-gate-only; current live classes 34 implement-or-refuse / 108 remediate / 17 prove / 63 retain; initial routing was 36 / 124 / 19 / 43; ten serial tranches; final audit remains open |

...
- Active increment: `G1-DOM-POR-D2 - POR COMMON-CONTRACT BOUNDARY DECIDED; method-specific source-bound correction limits and validity rules now sit beneath one common POR family/provenance/output-role/flag envelope; no production behavior or parameter value changed`

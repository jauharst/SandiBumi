...
- Accepted baseline: `this commit — G1-I006 atop dc88986 and GitHub-master anchor 02b59ea`
- Automated gate: `GREEN — 2026-08-10 on the exact G1-I006 working tree; 16 takeover-ledger + 13 frontend + 917 Rust passed, 0 failed, 36 ignored; production build and verification matrix green`
...
- Next increment: `write and approve the SB-CORE domain-adjudication implementation plan`
...
|---|---|---|---|
| G1-I006 — Customer-facing claim inventory | DONE | 29 claims traced: 5 proven, 6 qualified, 3 unmeasured, 11 remove-recommended, 3 legal-review, 1 undecided; Gate 1 remains open | this commit |

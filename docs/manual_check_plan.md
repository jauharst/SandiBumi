...
- [ ] **PR #2 merge**: review and merge `docs/prd-and-security-hardening` once it carries
      all master commits. You merge with your own credentials.
...
| PR #2 brought up to master | *(in progress)* | merge + push this session |

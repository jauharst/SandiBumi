...
# Porosity from Bateman-Konen N-D Crossplot

Module id `phi_dnbk` · category **Porosity** · [reference index](README.md)
...
- **Default:** -0.015 — source: Geolog V14 phi_dnbk.lls; docs/PRD_v2/11_porosity.md §5 line 1231
...
- **Default:** 1 — source: Geolog V14 phi_dnbk.lls; docs/PRD_v2/11_porosity.md §5 line 1231
- **Accepted range:** 0.5 to 1 v/v
- Competing shipped values exist for this parameter across installed tools (topic `shale_reduction_clamp`); the pane lists them with sources at the point of choice.

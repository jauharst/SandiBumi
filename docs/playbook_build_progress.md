...
blocks it with a "use SandiMin" message instead of silently running the superseded solver. Plus a
requested feature —
**V6 Raincloud** (PtitPrince-style half-violin + box + rain in the Vega panel). Each carries a REVIEW
"Try:" line; see the R6–R22 table below and REVIEW Rounds 61–81.

**Push state (2026-07-24):** everything through this update — both halves plus the whole R1–R22 fix
...
retirement guard — all browser-independent). R10/R15 have no

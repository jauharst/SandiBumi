...
usable samples" warning instead of a clean-looking metrics card. Plus a requested feature —
**V6 Raincloud** (PtitPrince-style half-violin + box + rain in the Vega panel). Each carries a REVIEW
"Try:" line; see the R6–R21 table below and REVIEW Rounds 61–80.

**Push state (2026-07-24):** everything through this update — both halves plus the whole R1–R21 fix
...
e2e tests still pass after the extraction — all browser-independent). R10/R15 have no

...
400,000-row query. Plus a requested feature —
**V6 Raincloud** (PtitPrince-style half-violin + box + rain in the Vega panel). Each carries a REVIEW
"Try:" line; see the R6–R20 table below and REVIEW Rounds 61–79.

**Push state (2026-07-24):** everything through this update — both halves plus the whole R1–R20 fix
...
across all three cap boundaries — all browser-independent). R10/R15 have no

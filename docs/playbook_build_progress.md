...
|---|---|---|
| 3a | Stratigraphic Modified Lorenz Plot (Σkh vs Σφh, slope-segment flow units) + `cargo test` (segment count on synthetic 3-unit column) | ▫ next |
| 3b | Pittman full-apex table (r25/r35/r50) alongside Winland R35; bank math in `docs/ref_rock_typing.md` | ▫ |
| 3c | Plots UI — Lorenz + Winland/Pittman crossplots (PlotCanvas + chartOverlay), RT class as FACIES block track, extend faciesTieDialog with k-variance-reduction | ▫ |

...
pub(crate) const METHOD_DERIVATIONS: &[(&str, DerivationClass, &str)] = &[
    ...
    ("ssc", DerivationClass::Cited, "docs/method_ssc_sspw.md - Sand-Silt-Clay on the N-D crossplot, after Kuttan et al., Log Interpretation in the Malay Basin, 21st SPWLA symposium; the shipped form carries SandiBumi modifications (gas conditioning, silt and dry-clay endpoint treatment) stated in the method note"),

...
test('the_live_gate_two_progress_receipt_accounts_for_every_handled_row_once', () => {
  ...
  // DEC-083 (2026-08-20): Gate 2 is formally CLOSED at 222 completed / 0 blocked -
  // SB-PLT-024 and SB-CORE-044 closed by owner decision with the counsel items
  // DEFERRED BY NAME to first commercial sale (pinned by tools/release-inventory.test.mjs).
  assert.equal(program.state, 'COMPLETE');
  assert.equal(program.completed_requirements.length, 222);
  assert.equal(program.blocked_requirements.length, 0);
  assert.ok(program.completed_requirements.includes('SB-PLT-024'));
  assert.ok(program.completed_requirements.includes('SB-CORE-044'));
  assert.equal(handled.size, 222, 'completed and blocked receipts must not overlap');
  assert.equal(program.gate2_requirement_count - handled.size, 0);
  ...
  assert.ok(program.completed_requirements.includes('SB-CLY-055'));
  assert.ok(program.completed_requirements.includes('SB-POR-001'));
  assert.ok(program.completed_requirements.includes('SB-POR-002'));
  assert.ok(program.completed_requirements.includes('SB-POR-003'));
  ...
  assert.ok(program.completed_requirements.includes('SB-POR-010'));
  assert.ok(program.completed_requirements.includes('SB-POR-011'));
  assert.ok(program.completed_requirements.includes('SB-POR-021'));
  assert.ok(program.completed_requirements.includes('SB-POR-023'));
  assert.ok(program.completed_requirements.includes('SB-POR-024'));
  assert.ok(program.completed_requirements.includes('SB-POR-025'));
  assert.ok(program.completed_requirements.includes('SB-POR-026'));
  assert.ok(program.completed_requirements.includes('SB-POR-028'));
  assert.ok(program.completed_requirements.includes('SB-POR-043'));
  assert.ok(program.completed_requirements.includes('SB-POR-044'));
  assert.ok(program.completed_requirements.includes('SB-POR-045'));
  assert.ok(program.completed_requirements.includes('SB-POR-047'));
  assert.ok(program.completed_requirements.includes('SB-POR-048'));
  assert.ok(program.completed_requirements.includes('SB-POR-049'));
  assert.ok(program.completed_requirements.includes('SB-POR-054'));
  assert.ok(program.completed_requirements.includes('SB-POR-055'));
  assert.ok(program.completed_requirements.includes('SB-POR-056'));
  assert.ok(program.completed_requirements.includes('SB-POR-057'));
  assert.ok(program.completed_requirements.includes('SB-SAT-001'));
  assert.ok(program.completed_requirements.includes('SB-SAT-002'));
  assert.ok(program.completed_requirements.includes('SB-SAT-006'));
  assert.ok(program.completed_requirements.includes('SB-SAT-023'));
  assert.ok(program.completed_requirements.includes('SB-SAT-025'));
  assert.ok(program.completed_requirements.includes('SB-SAT-026'));
  assert.ok(program.completed_requirements.includes('SB-SAT-027'));
  ...
  assert.ok(program.completed_requirements.includes('SB-CUT-001'));
  assert.ok(program.completed_requirements.includes('SB-CUT-002'));
